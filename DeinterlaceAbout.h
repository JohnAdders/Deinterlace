///////////////////////////////////////////////////////////////////////////////
// $Id: DeinterlaceAbout.h,v 1.2 2001-11-15 12:42:47 adcockj Exp $
/////////////////////////////////////////////////////////////////////////////
...
#ifndef __DEINTERLACEABOUT_H__
#define __DEINTERLACEABOUT_H__

#include "Deinterlace.h"

class CDeinterlaceAbout : public CBasePropertyPage
{
public:
    static CUnknown* WINAPI CreateInstance(LPUNKNOWN lpunk, HRESULT* phr);

private:
    CDeinterlaceAbout(LPUNKNOWN lpunk, HRESULT* phr);
