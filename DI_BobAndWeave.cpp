/////////////////////////////////////////////////////////////////////////////
// $Id: DI_BobAndWeave.cpp,v 1.4 2001-11-13 13:51:43 adcockj Exp $
/////////////////////////////////////////////////////////////////////////////
...
// Gunnar Thalin
///////////////////////////////////////////////////////////////////////////////
BOOL __cdecl DeinterlaceFieldBob(DEINTERLACE_INFO *info)
{
    int Line;
    short* YVal1;
    short* YVal2;
...
//
BOOL __cdecl DeinterlaceFieldWeave(DEINTERLACE_INFO *info)
{
    int Line;
    short* YVal1;
    short* YVal2;
...
// copied twice.
/////////////////////////////////////////////////////////////////////////////
BOOL __cdecl Bob(DEINTERLACE_INFO *info)
{
    int i;
...
BOOL __cdecl Weave(DEINTERLACE_INFO *info)
{
    int i;
    BYTE *lpOverlay = info->Overlay;
